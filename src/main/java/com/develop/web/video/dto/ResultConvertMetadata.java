...
public class ResultConvertMetadata {
    ...
    public ResultConvertMetadata(Integer ingest_id, Integer team_id, Integer folder_id, Integer archive_metadata_id, Integer convert_metadata_id, LocalDateTime ingest_at, LocalDateTime end_at) {
